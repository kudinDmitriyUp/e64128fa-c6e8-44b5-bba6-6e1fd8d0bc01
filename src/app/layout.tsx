...
export const metadata: Metadata = {
  title: "Fresh Fund | Tel Aviv Tech Investment",
  description: "Fresh Fund is a premier venture capital firm investing in innovative technology companies from Tel Aviv and globally. Backed by experienced investors and operators.",
  keywords: "venture capital, tech investment, Tel Aviv startups, early-stage funding, technology investors",
  metadataBase: new URL("https://freshfund.io"),
  alternates: {
    canonical: "https://freshfund.io"
  },
  openGraph: {
    title: "Fresh Fund | Tech Investment Reimagined",
    description: "Backing visionary entrepreneurs transforming the global tech landscape from Tel Aviv.",
    type: "website",
    siteName: "Fresh Fund"
  },
  twitter: {
    card: "summary_large_image",
    title: "Fresh Fund | Tech Investment",
    description: "Premier VC firm investing in exceptional technology companies from Tel Aviv"
  }
};
